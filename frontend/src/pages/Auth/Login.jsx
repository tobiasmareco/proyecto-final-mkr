      ...
      <div className='bg-white shadow-xl max-w-md mx-auto py-3 px-5 rounded-sm'>
        ...
        <form action="" className='' onSubmit={handleSubmit}>
          <div className='my-3'>
            ...
            <input type="text" className='w-full  p-2 border rounded-xl bg-gray-50' id='email' name='email' value={email} onChange={(e)=>{setEmail(e.target.value)}}/>
          </div>
          <div className='my-3'>
            ...
            <input type="password" className='w-full  p-2 border rounded-xl bg-gray-50' id='password' name='password' />
          </div>
          <input type="submit" value='Sign in' className='bg-sky-700 w-full py-3 text-white font-bold uppercase rounded-md cursor-pointer hover:bg-sky-800 mb-5' />
        </form>
